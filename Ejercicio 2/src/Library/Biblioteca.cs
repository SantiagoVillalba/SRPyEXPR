...
namespace SRP
{
    ...
    ambos en String. Teniendo esta clase biblioteca se cumple con el principio SRP ya que la biblioteca si el libro cambia o etc, esta abstraida de el libro en si, y solo se encarga de conocer el sector y estante.
    Y tambien cumple con el patron Expert ya que la biblioteca es la que tiene la responsabilidad de conocer el estante y el sector, y no asi el libro, ya que con este no tiene nada que ver.
    Con esta aplicacion y las relaciones entre clases, podemos desde la biblioteca buscar pasando por parametro un libro y este nos devolvera su ubicacion con el metodo DevolverSectorYEstante, que esto tiene
    mas sentido que el libro fuera el que tuviera estas responsabilidades. */
